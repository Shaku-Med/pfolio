...
let About = () => {
    ...
    return (
        <>
            <div className={`profHm transition-all min-[1400px]:scale-[1.1] p-2 flex items-center justify-between flex-col h-full bd overflow-hidden`}>
                <div className={`MlTpt w-full max-w-[1000px] transition-all min-[1400px]:max-w-[80%] p-2 h-full`}>
                    <h1 className={`bildAb sapAnim animate__fadeInUp text-[var(--txt)] text-5xl font-bold p-4 capitalize mt-4 mb-4`}>
                        About Me
                    </h1>
                    <div className={`mXmta transition-all min-[1400px]:gap-6 px-10 animate__bounceInUp max-[600px]:px-5 flex items-start gap-2 h-full w-full max-[900px]:flex-col`}>
                        ...
                        <div className={`imageOfME transition-all min-[1400px]:scale-[1.2] relative h-full w-full p-2 flex items-center justify-center`}>
                            ...
                            <div className="ctain ahinkeas">
                                <div className="imgPth sapAnim h-[300px] w-[300px] overflow-hidden">
                                    <img className={` w-full sapAnim h-full object-cover object-center`} src={`./ME/me${t > 0 ? t : 1}.png`} alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
